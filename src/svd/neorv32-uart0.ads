...
package neorv32.UART0 is
   ...
   subtype CTRL_UART_CTRL_TX_NFULL_Field is neorv32.Bit;
   ...
   subtype CTRL_UART_CTRL_IRQ_TX_NFULL_Field is neorv32.Bit;
   ...
   type CTRL_Register is record
      ...
      --  unspecified
      Reserved_24_29          : neorv32.UInt6 := 16#0#;
