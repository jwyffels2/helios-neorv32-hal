...
package neorv32.SYSINFO is
   ...
   subtype MEM_SYSINFO_MISC_HART_Field is neorv32.UInt4;
   subtype MEM_SYSINFO_MISC_BOOT_Field is neorv32.UInt2;
   subtype MEM_SYSINFO_MISC_ITMO_Field is neorv32.UInt5;
   subtype MEM_SYSINFO_MISC_ETMO_Field is neorv32.UInt5;
   ...
   type MEM_Register is record
      ...
      SYSINFO_MISC_ITMO : MEM_SYSINFO_MISC_ITMO_Field;
      --  Read-only. log2(external bus timeout cycles)
      SYSINFO_MISC_ETMO : MEM_SYSINFO_MISC_ETMO_Field;
   end record
   ...
   subtype SOC_SYSINFO_SOC_IO_TRACER_Field is neorv32.Bit;
   ...
   subtype CACHE_SYSINFO_CACHE_INST_BURSTS_EN_Field is neorv32.Bit;
   subtype CACHE_SYSINFO_CACHE_DATA_BURSTS_EN_Field is neorv32.Bit;
   ...
   type CACHE_Register is record
      ...
      --  Read-only. i-cache: burst transfers enabled
      SYSINFO_CACHE_INST_BURSTS_EN  : CACHE_SYSINFO_CACHE_INST_BURSTS_EN_Field;
      --  unspecified
      Reserved_17_23                : neorv32.UInt7;
      --  Read-only. d-cache: burst transfers enabled
      SYSINFO_CACHE_DATA_BURSTS_EN  : CACHE_SYSINFO_CACHE_DATA_BURSTS_EN_Field;
      --  unspecified
      Reserved_25_31                : neorv32.UInt7;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
